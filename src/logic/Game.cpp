...
void Game::buildChanceDeck() {
  ...
  cards.push_back(std::unique_ptr<core::ActionCard>(new core::ChanceCard(
      "Bank pays you Rp50", [](core::Player& p, core::GameContext& ctx) {
        ctx.payPlayerFromBank(p, 50);
      })));
...
void Game::buildCommunityChestDeck() {
  std::vector<std::unique_ptr<core::ActionCard>> cards;
  cards.push_back(
      core::CommunityChestCard::makeCollect(100, "Bank pays you Rp100"));
  cards.push_back(
      core::CommunityChestCard::makeCollect(50, "Bank pays you Rp50"));
  cards.push_back(
      core::CommunityChestCard::makePayBank(50, "Pay hospital Rp50"));
