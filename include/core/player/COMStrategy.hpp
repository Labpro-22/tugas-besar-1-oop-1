...
class COMStrategy {
 public:
   ...
   */
  virtual bool shouldBuy(Property* property, Player& player,
                         logic::Game& game) const noexcept = 0;
   ...
   */
  virtual int bidAmount(Property* property, Player& player, logic::Game& game,
   ...
   */
  virtual bool shouldBuild(Property* property, Player& player,
                           logic::Game& game) const noexcept = 0;
   ...
   */
  virtual bool shouldMortgage(Property* property, Player& player,
                              logic::Game& game) const noexcept = 0;
