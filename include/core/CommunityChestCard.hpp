...
public:
     ...
     */
    static std::unique_ptr<ActionCard> makeCollectFromAll(int amount, std::string description);
     ...
     */
    static std::unique_ptr<ActionCard> makePayToAll(int amount, std::string description);
