...
class ChanceCard : public ActionCard {
 public:
   ...
   * `getCardType`.
   */
  ChanceCard(std::string description,
   ...
   */
  static std::unique_ptr<ActionCard> makeMoveBack(int spaces,
   ...
   * @note Extension (not in spec).
   */
  static std::unique_ptr<ActionCard> makeAdvanceTo(int index,
                                                   std::string description);
   ...
   */
  static std::unique_ptr<ActionCard> makeAdvanceToNearestRailroad(
      std::string description);
