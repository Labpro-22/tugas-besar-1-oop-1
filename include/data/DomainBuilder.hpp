...
/**
 * @brief Converts raw config objects (from ConfigReader) into core domain
 * objects.
 *
 * Tanggung jawab:
...
class DomainBuilder {
 public:
   ...
   */
  static std::unique_ptr<core::Property> buildProperty(
      const PropertyConfig& cfg);

  /**
   * @brief Gabungkan property.txt dan aksi.txt menjadi vector TileEntry terurut
   * posisi.
   *
   * Algoritma:
   ...
   *
   * @throws InvalidConfigException jika ada posisi duplikat atau tipe tidak
   * dikenali.
   */
